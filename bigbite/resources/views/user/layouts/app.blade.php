...
<html lang="en" ng-app="{{ config('app.name') }}" lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default"
    ...
    <head>
        ...
        <meta name="user_id" content="{{ optional(Auth::guard('sales')->user())->id }}">
    ...
    <body>
       <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                @include('user.layouts.elements.left_sidebar')
                <div class="layout-page">
                    ...
                    @include('user.layouts.elements.right_sidebar')
                </div>
                ...
                @yield('script')
                @include('user.layouts.elements.sweet_alerts')
            </div>
